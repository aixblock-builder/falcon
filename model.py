...
class MyModel(AIxBlockMLBase):
    ...
    def action(self, command, **kwargs):
        ...
        if command.lower() == "execute":
            ...
            model_id = kwargs.get("model_id", "tiiuae/Falcon3-1B-Instruct")
            ...
            hf_model_id = kwargs.get("hf_model_id", "tiiuae/Falcon3-1B-Instruct")
    ...
    def model(self, **kwargs):
        ...
        model_id_demo = kwargs.get("model_id", "tiiuae/Falcon3-1B-Instruct")
        project_id = kwargs.get("project_id", 0)
